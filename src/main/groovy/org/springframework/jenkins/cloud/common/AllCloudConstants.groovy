...
class AllCloudConstants {
	 ...
	 */
	public static final String DEFAULT_RELEASER_SKIPPED_PROJECTS = "spring-boot,spring-cloud-stream,spring-cloud-stream-binder-rabbit,spring-cloud-schema-registry,spring-cloud-stream-binder-kafka,spring-cloud-stream-starters,spring-cloud-function"
